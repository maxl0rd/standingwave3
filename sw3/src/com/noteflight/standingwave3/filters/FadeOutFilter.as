...
package com.noteflight.standingwave3.filters
{
    ...
    public class FadeOutFilter extends AbstractFilter
    {
        ...
        public function FadeOutFilter(source:IAudioSource, envelope:IDirectAccessSource, fadeStart:Number = -1)
        {
            ...
            if (fadeStart < 0) {
            	this._fadeStart = Math.floor(source.frameCount - envelope.frameCount);
            } else {
            	this._fadeStart = Math.floor(fadeStart * source.descriptor.rate);
            }
            this._fadeDuration = Math.floor(envelope.frameCount);
        }
        ...
        */
        ...
        {
        	_fadeStart = Math.floor(t * _source.descriptor.rate);
        }
        ...
        */
        ...
        override public function get frameCount():Number
		{
			...
			return Math.floor(Math.min(_source.frameCount, _fadeStart + _fadeDuration));
		} 
