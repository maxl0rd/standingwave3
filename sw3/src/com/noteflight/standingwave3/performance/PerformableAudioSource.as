...
package com.noteflight.standingwave3.performance
{
    ...
    /**
     * A PerformableAudioSource is an IAudioSource with a specific start index in sample frames.
     */
    public class PerformableAudioSource
    {
        ...
        /**
         * Create a PerformableAudioSource that renders the given source at a particular time onset. 
         ...
         */
        public function PerformableAudioSource(startTime:Number, source:IAudioSource, gain:Number=0, pan:Number=0)
        {
        ...
        public function set onset(startTime:Number):void {
        	_start = Math.floor(startTime * source.descriptor.rate);
        }
        
        public function get onset():Number {
